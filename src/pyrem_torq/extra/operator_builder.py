...
class OperatorBuilder(object):
    def __init__(self, 
        ...
        """ Generates a new OperatorBuilder object.
            atomicTermExpr i an TorqExpression object. A sequence which matches it will 
            be recognized an atomic item and not be parsed further.
            composedTermNodeLables is a list of labels. Nodes who have one of them will
            be recognized an expression, which may include another expression inside.
            generatedTermLabel is a label. An expression parsed by a TorqExpression object
            (generated by self.build_*_expr() method) will be enclosed by a node with
            this label.
        """
